/**
 * CommentVersionHistory Component
 *
 * Dialog for admins/moderators to view comment edit history.
...
import { getCommentVersions } from "@/lib/api/comments";
import type { CommentVersion } from "@/types/comment";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            View all previous versions of this comment
          </DialogDescription>
        </DialogHeader>
